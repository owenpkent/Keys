...
This is the dated log of how Keys came to work the way it does: what was asked for, in Owen's
own words where they were the ask, what was built, and what each round superseded; CLAUDE.md's
Architecture section is the other half, the map of what is true today. Entries are newest first,
so the top of the file is the most recent round and the bottom is the oldest thing still
